...
-- Ensure review_id is auto-incrementing so subsequent INSERTs without review_id succeed.
-- This ALTER will make review_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY if possible.
-- Safety: check current max review_id before running this on a populated table.
-- You can run: SELECT MAX(review_id) FROM reviews; and SHOW CREATE TABLE reviews; before executing.

ALTER TABLE reviews
  MODIFY COLUMN review_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY;
...
INSERT INTO reviews (customer_id, trip_id, rating, comment, review_date) VALUES
  (1, 1, 5, 'Excellent driver and comfortable seats. On-time and smooth journey.', '2025-11-29 10:30:00'),
  (2, 1, 4, 'Good trip; minor delay at boarding but overall pleasant.', '2025-11-29 11:00:00'),
  (3, 2, 3, 'Average experience. Bus was a bit worn but staff were polite.', '2025-11-29 11:15:00'),
  (4, 3, 5, 'Fantastic service and clean bus. Would travel again.', '2025-11-29 12:00:00'),
  (5, 4, 2, 'Too noisy and AC not working properly.', '2025-11-29 12:30:00'),
  (6, 5, 4, 'Good value for money. Comfortable journey.', '2025-11-29 13:00:00'),
  (7, 6, 5, 'Driver very professional, great driving.', '2025-11-29 13:30:00'),
  (8, 7, 4, 'On-time, helpful staff, decent food stop.', '2025-11-29 14:00:00'),
  (9, 8, 3, 'Seats were cramped on this trip.', '2025-11-29 14:30:00'),
  (10,9, 5, 'Outstanding experience, highly recommended!', '2025-11-29 15:00:00'),
  (1, 2, 4, 'Nice trip; arrival earlier than estimated.', '2025-11-29 15:30:00'),
  (2, 3, 3, 'Timings can be improved; otherwise ok.', '2025-11-29 16:00:00'),
  (3, 4, 4, 'Good crew, bus maintained well.', '2025-11-29 16:30:00'),
  (4, 5, 2, 'Uncomfortable seats for long distances.', '2025-11-29 17:00:00'),
  (5, 6, 5, 'Very safe driving and polite staff.', '2025-11-29 17:30:00'),
  (6, 7, 4, 'Smooth ride but restroom needed.', '2025-11-29 18:00:00'),
  (7, 8, 5, 'I loved the experience. Clean and prompt.', '2025-11-29 18:30:00'),
  (8, 9, 3, 'Average. Nothing exceptional.', '2025-11-29 19:00:00'),
  (9,10, 4, 'Good seats and friendly crew.', '2025-11-29 19:30:00'),
  (10,1, 5, 'Repeat traveler — never disappointed.', '2025-11-29 20:00:00');
